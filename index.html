...
.w3-green, .w3-hover-green:hover {
   ...
   <body>
               ...
               <div class="row align-items-center">
                  <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-2 col-sm-4 col-6">
                     <div class="header__left d-flex">
                        <div class="logo">
                           <a href="index.html">
                              <img src="assets/img/logo/logo.png" alt="logo" style="width:70%">
                           </a>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-9 col-xl-9 col-lg-8 col-md-10 col-sm-8 col-6">
                     <div class="header__right d-flex justify-content-end align-items-center">
                        ...
                        <div class="header__btn header__btn-2 ml-50 d-none d-sm-block">
                           <a href="#" class="e-btn">S'inscrire</a>
                        </div>
      ...
      <main>
                     ...
                     <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="hero__content hero__content-2 p-relative z-index-1">
                           <h3 class="hero__title hero__title-2">
                              Apprendre devient<br>
                              <span class="yellow-shape">un jeu <img src="assets/img/shape/yellow-bg.png" alt="yellow-shape"></span> d'enfant !
                           </h3><br>
                           ...
                           <div class="hero__thumb-2 scene">
                              ...
                              <div class="hero__promotion d-flex white-bg layer" data-depth="0.1">
                                 ...
                                 <div class="hero__promotion-text">
                                    <h5>Félicitation</h5>
                                    <p>Vous venez de passer au niveau suivant !</p>
                                 </div>
                              </div>
                              <div class="hero__promotion education d-none d-lg-flex white-bg layer" data-depth="0.2" >
                                 ...
                                 <div class="hero__promotion-text">
                                    <h5><span class="counter">9</span> Thématiques différentes</h5>
                                    <p>Avec une trenteine d'exercices</p>
                                 </div>
                              </div>
                              <div class="hero__class d-none d-lg-flex layer" data-depth="0.3">
                                 ...
                                 <div class="hero__class-text">
                                    <h5>Jean Paul</h5>
                                    <p>Disponible</p>
                                    <a href="contact.html">Rejoindre maintenant</a>
                                 </div>
                              </div>
                              <div class="hero__mic">
                                 <span>
         ...
         <!-- services area start -->
         <section class="services__area pt-115 pb-40" id="apropos">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
                     <div class="section__title-wrapper section-padding mb-60 text-center">
                        <h2 class="section__title">A propos de <span class="yellow-bg">nous <img src="assets/img/shape/yellow-bg-2.png" alt=""></span></h2>
                        <p>Apprenez l'anglais en joueant et en discutant avec des personnes</p>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item blue-bg-4 mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="about.html">+300 <br> Exercices en ligne</a></h3>
                           <p>Découvrez nos différents exercices !</p>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item pink-bg mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="about.html">Apprendre tout en s'amusant</a></h3>
                           <p>On peut apprendre efficacement sans s'ennuyer</p>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item purple-bg mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="about.html">Communiquer avec des étrangers</a></h3>
                           <p>Apprenez à communiquer en toute confiance !</p>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item green-bg mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="about.html">Un large choix d'activités</a></h3>
                           <p>Des contenus intéressants et interactifs !</p>
                  ...
                  <div class="col-xxl-5 offset-xxl-1 col-xl-6 col-lg-6">
                     <div class="about__thumb-wrapper">
                        ...
                        <div class="about__review">
                           <h5> <span>+300</span> différents exercices</h5>
                        </div>
                        <div class="about__thumb ml-100">
                           <img src="assets/img/about/about.png" alt="" style="width:50%;">
                        </div>
                        <div class="about__banner mt--210">
                           <img src="assets/img/about/Mobile app.png" alt="" style="width:30%;">
                        </div>
                        <!-- <div class="about__student ml-270 mt--80"> -->
                           ...
                           <!-- </a> -->
                           <!-- <p>Rejoingnez <span>+200</span> utilisateurs</p> -->
                        <!-- </div> -->
                     </div>
                  </div>
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="about__content pl-70 pr-60 pt-25">
                        <div class="section__title-wrapper mb-25">
                           <h2 class="section__title">Atteignez vos <br><span class="yellow-bg-big">objectifs<img src="assets/img/shape/yellow-bg-2.png" alt=""></span>  avec notre application </h2>
                           <p>Développe tes compétences jour après jour grâce à nos exercices qui te permettent de t'entraîner à lire, à écouter et à parler la langue.</p>
                        </div>
                        <div class="about__list mb-35">
                           <ul>
                              <li class="d-flex align-items-center"> <i class="icon_check"></i> Améliorer votre niveau d'anglais</li>
                              <li class="d-flex align-items-center"> <i class="icon_check"></i> Accéder à plus exercices avec différentes thématiques</li>
                              <li class="d-flex align-items-center"> <i class="icon_check"></i> Communiquer avec de nouvelles personnes</li>
                           </ul>
                        </div>
                        <a href="contact.html" class="e-btn e-btn-border">Rejoindre maintenant</a>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <!-- about area end -->
		          ...
		          <!-- category area start -->
         <section class="category__area pt-120 pb-70" style="background-color:#f3f4f8">
            <div class="container">
               <div class="row align-items-end">
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                     <div class="section__title-wrapper mb-45">
                        <h2 class="section__title">Découvrez <br>nos différentes <span class="yellow-bg">Thématiques <img src="assets/img/shape/yellow-bg-2.png" alt="">  </span>
                        </h2>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="#">Réseaux Sociaux</a></h4>
                           <p>Discuter des tendances</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           ...
                           <p>Améliorer votre communication</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="#">Sport & Santé</a></h4>
                           <p>Vos bonne habitudes</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="#">Musique</a></h4>
                           <p>Vos styles et morceaux préférés</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="#">Université</a></h4>
                           <p>Vos études et cours</p>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <!-- <div class="row"> -->
                  <!-- <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2"> -->
                     <!-- <div class="section__title-wrapper mb-60 text-center"> -->
                        <!-- <h2 class="section__title">What is <span class="yellow-bg-big">Skilline? <img src="assets/img/shape/yellow-bg-2.png" alt=""></span></h2> -->
         ...
         <!-- why area start -->
         <section class="why__area pt-125" id="comment">
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-6 col-md-8">
                     <div class="why__content pr-50 mt-40">
                        <div class="section__title-wrapper mb-30">
                           <span class="section__sub-title">Comment ça marche ?</span>
                           <h2 class="section__title" style="font-size: 34px;">Commencer à apprendre en <span class="yellow-bg yellow-bg-big">Communiquant<img src="assets/img/shape/yellow-bg.png" alt=""></span></h2>
                           <p>Discutez avec des personnes par messages écrits, enregistrements vocaux, appels vocaux ou encore appels vidéo ! Quelle que soit votre préférence de communication, nous avons ce qu'il vous faut.</p>
                        </div>
                        <div class="why__btn">
                           <a href="contact.html" class="e-btn e-btn-3 mr-30">S'inscrire</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-8">
                     <div class="why__thumb">
                        <img src="assets/img/why/why.png" alt="" style="width:70%">
  ...
  <h2 class="section__title" style="font-size: 34px;">Un système de <span class="yellow-bg yellow-bg-big">niveau<img src="assets/img/shape/yellow-bg.png" alt=""></span> de progression</h2>
  <p>Reussisez des exercices pour gagner en niveau !</p>
  ...
  <p id="myP">Exercice <span id="demo">0</span> sur 10</p>

  <button class="e-btn e-btn-3 mr-30" onclick="move();this.disabled='true'">Passer au niveau suivant</button> 
</div>
...
function move() {
  ...
  function frame() {
    if (width >= 100) {
      ...
      document.getElementById("myP").innerHTML = "Félicitation vous venez de passé au niveau 2 !";
    } else {
      width++; 
      ...
      document.getElementById("demo").innerHTML = num;
				  ...
				  <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-8" style="padding-top:100px; padding-bottom:100px">
                     <div class="why__thumb">
                        <img src="assets/img/why/why2.png" alt="">
                        <img class="why-green" src="assets/img/why/why-shape-green.png" alt="">
                        <img class="why-pink" src="assets/img/why/why-shape-pink.png" alt="">
                        <img class="why-dot" src="assets/img/why/why-shape-dot.png" alt="">
                        <img class="why-line" src="assets/img/why/why-shape-line.png" alt="">
				  ...
				  <div class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-6 col-md-8">
                     <div class="why__content pr-50 mt-40">
                        <div class="section__title-wrapper mb-30">
                           <h2 class="section__title" style="font-size: 34px;">Des <span class="yellow-bg yellow-bg-big">Badges<img src="assets/img/shape/yellow-bg.png" alt=""></span> à collectionner</h2>
                           <p>Gagner des badges en réuissisant l'ensemble des exercices, chaque thématique dispose d'un badge unique pour chaque niveau à collectionner !</p>
                        </div>
                        <div class="why__btn">
                           <a href="contact.html" class="e-btn e-btn-3 mr-30">S'inscrire</a>
                        </div>
               ...
               <!-- <div class="row"> -->
                  <!-- <div class="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3"> -->
                     <!-- <div class="section__title-wrapper text-center mb-60"> -->
                        <!-- <h2 class="section__title">Nous sommes <span class="yellow-bg yellow-bg-big">fiers<img src="assets/img/shape/yellow-bg.png" alt=""></span></h2> -->
         ...
         <!-- contact area start -->
         <section class="contact__area pt-115 pb-120" id="contact">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-7 col-xl-7 col-lg-6">
                     <div class="contact__wrapper">
                        <div class="section__title-wrapper mb-40">
                           <h2 class="section__title">Entrer en <span class="yellow-bg yellow-bg-big">contact<img src="assets/img/shape/yellow-bg.png" alt=""></span></h2>
                           <p>Vous avez une question ? N'hésitez pas à prendre contact avec nous</p>
                        </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-xxl-12">
                                    <div class="contact__form-agree  d-flex align-items-center mb-20">
                                       ...
                                       <label class="e-check-label" for="e-agree">J'accepte les<a href="#">termes et conditions</a></label>
                                    </div>
                                 </div>
                                 <div class="col-xxl-12">
                                    <div class="contact__btn">
                                       <button type="submit" class="e-btn">Envoyer le message</button>
                                    </div>
                                 </div>
                              </div>
                           </form>
                           ...
                           <ul>
                              <li>
                                 <div class="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div class="contact__info-text">
                                       <h4>Toulouse</h4>
                                       <p><a target="_blank" href="https://www.google.com/maps/place/Dhaka/@23.7806207,90.3492859,12z/data=!3m1!4b1!4m5!3m4!1s0x3755b8b087026b81:0x8fa563bbdd5904c2!8m2!3d23.8104753!4d90.4119873">373 L'Occitane, 31670 Labège</a></p>
                              ...
                              <li>
                                 <div class="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div class="contact__info-text">
                                       <h4>E-Mail</h4>
                                       <p><a href="mailto:contact.playstudy@gmail.com">contact.playstudy@gmail.com</a></p>
                                    </div>
                                 </div>
                              </li>
                              <li>
                  ...
                  <div class="row align-items-center">
                     <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-6">
                        <div class="cta__content">
                           <h3 class="cta__title" style="font-size:37px;">Commencez à apprendre en téléchargeant notre application.</h3>
                        </div>
                     </div>
                  ...
                  <div class="container">
                     <div class="row">
                           ...
                           <div class="footer__widget mb-50">
                              <div class="footer__widget-head mb-22">
                                 <div class="footer__logo">
                                    <a href="index.html">
                                       <img src="assets/img/logo/logo.png" alt="" style="width:90%">
                                    </a>
                                 </div>
                              </div>
                              <div class="footer__widget-body footer__widget-body-2">
                                 <p>Apprendre devient un jeu d'enfant !</p>
                        ...
                        <div class="col-xxl-2 offset-xxl-1 col-xl-2 offset-xl-1 col-lg-3 offset-lg-0 col-md-2 offset-md-1 col-sm-5 offset-sm-1">
                           <div class="footer__widget mb-50">
                              <div class="footer__widget-head mb-22">
                                 <h3 class="footer__widget-title footer__widget-title-2">Entreprise</h3>
                              </div>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-5 col-sm-6">
                           <div class="footer__widget footer__pl-70 mb-50">
                              <div class="footer__widget-head mb-22">
                                 <h3 class="footer__widget-title footer__widget-title-2">S'inscrire</h3>
                              </div>
                              <div class="footer__widget-body">
                     ...
                     <div class="row">
                        <div class="col-xxl-12">
                           <div class="footer__copyright footer__copyright-2 text-center">
                              <p>© 2022 Play-Study, All Rights Reserved. Design By <a href="#">Play-Study</a></p>
                           </div>
                        </div>
                     </div>
                  </div>
